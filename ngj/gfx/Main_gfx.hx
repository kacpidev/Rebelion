...
class Main_gfx 
{
	...
	public function init(s2d:Dynamic)
	{
		...
		var bckg_layer1_bmp = new h2d.Bitmap(bckg_1, bckgLayer1);
		var bckg_layer2_bmp = new h2d.Bitmap(bckg_2, bckgLayer2);
		var bckg_layer3_bmp = new h2d.Bitmap(bckg_3, bckgLayer3);
		var bckg_layer4_bmp = new h2d.Bitmap(bckg_4, bckgLayer4);
		var bckg_layer5_bmp = new h2d.Bitmap(bckg_5, bckgLayer5);
	
		bckg_layer1_bmp.x = s2d.width / 2 - bckg_1.width/2;
		bckg_layer1_bmp.y = 0;

		bckg_layer2_bmp.x = s2d.width / 2 - bckg_1.width/2;
		bckg_layer2_bmp.y = 0;

		bckg_layer3_bmp.x = s2d.width / 2 - bckg_1.width/2;
		bckg_layer3_bmp.y = 0;

		bckg_layer4_bmp.x = s2d.width / 2 - bckg_1.width/2;
		bckg_layer4_bmp.y = 0;

		bckg_layer5_bmp.x = s2d.width / 2 - bckg_1.width/2;
		bckg_layer5_bmp.y = 0;
